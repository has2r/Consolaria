...
namespace Consolaria
{
    ...
    public static class Helper
    {
        ...
        public static bool ChineseNewYear;
        ...
        public static void checkEaster()
        {
            ...
            int day = now.Day;
            int month = now.Month;
            if ((day >= 1 && month == 4) && ServerConfig.Instance.SeasonsEnabled)
                Easter = true;
            else if ((day <= 1 && month == 5) && ServerConfig.Instance.SeasonsEnabled)
                Easter = true;
            else
                Easter = false;
        }
        ...
        public static void checkThanksgiving()
        {
            ...
            int day = now.Day;
            int month = now.Month;
            if ((day >= 1 && month == 11) && ServerConfig.Instance.SeasonsEnabled)
                Thanksgiving = true;
            else if ((day <= 1 && month == 12) && ServerConfig.Instance.SeasonsEnabled)
                Thanksgiving = true;
            else
                Thanksgiving = false;
        }
